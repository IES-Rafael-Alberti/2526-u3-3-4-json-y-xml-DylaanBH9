...
def inicializar_datos(archivo_origen: str):
    try:
        arbol = ET.parse(archivo_origen)
        arbol.write("otros/datos_usuarios.xml")
        print(f"Datos inicializados desde '{archivo_origen}' a 'src/otros/datos_usuarios.xml'.")
